  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'm1',
      sender: 'bot',
      text: 'เจริญพร! ยินดีต้อนรับสู่ระบบช่วยเหลือ บาลีเศรษฐี (Pali Assistant Bot) มีข้อสงสัยเรื่องไวยากรณ์บาลี หรือต้องการทดสอบความรู้ สามารถพิมพ์ถามได้เลยครับ 🙏',
