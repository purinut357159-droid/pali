        ...
        {!isStarted ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '16px 8px 8px 8px' }}>
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', marginBottom: '20px', lineHeight: 1.6, maxWidth: '440px' }}>
              {mode === 'buy' && 'กดปุ่มด้านล่างเพื่อเริ่มทำข้อสอบ (จะเริ่มนับเวลาถอยหลัง 15 วินาที) ตอบให้ถูกต้องเพื่อครอบครองวิชานี้!'}
              {mode === 'upgrade' && 'กดปุ่มด้านล่างเพื่อเริ่มทำข้อสอบ (จะเริ่มนับเวลาถอยหลัง 15 วินาที) ตอบให้ถูกต้องเพื่ออัปเกรดสำนักเรียน!'}
              {mode === 'quiz' && 'ห้องติวเพิ่มเติม: มีเวลา 15 วินาที ตอบถูกรับ +150 แต้ม (⚠️ หากตอบผิดสะสมครบ 3 ข้อ จะต้องหยุดเดิน 1 ตา)'}
              {mode === 'exam' && 'สนามสอบเปรียญ: มีเวลา 15 วินาที ตอบถูกรับแต้มปัญญาโบนัสใหญ่ +300 แต้ม!'}
